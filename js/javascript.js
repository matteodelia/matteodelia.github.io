...
function mobile_src() {
  ...
  if (width < 1200) {
    document.getElementById("video_container").innerHTML =
      `
    <img src="img/narrative/tobeornottobe.jpg" class="video" id="V19">
    <img src="img/narrative/einfall.jpg" class="video" id="V18">
    <img src="img/narrative/confessioni.jpg" class="video" id="V17">
    <img src="img/brand/francia.jpg" class="video adv_content" id="V16">
    <img src="img/brand/mango_home.jpg" class="video adv_content" id="V15">
    <img src="img/brand/puma.jpg" class="video adv_content" id="V14">
    <img src="img/brand/mango_man.jpg" class="video adv_content" id="V13">
    <img src="img/brand/timberland.jpg" class="video adv_content" id="V12">
    <img src="img/brand/stoffa_lookbook.jpg" class="video adv_content" id="V11">
    <img src="img/documentary/iononhopaura.jpg" class="video documentary_content" id="V10">
    <img src="img/documentary/lafuria.jpg" class="video documentary_content" id="V9">
    <img src="img/music/giornoenotte.jpg" class="video music_content" id="V8">
    <img src="img/music/habitatcielo.jpg" class="video music_content" id="V7">
    <img src="img/music/chilometri.jpg" class="video music_content" id="V6">
    <img src="img/music/crescere.jpg" class="video music_content" id="V5">
    <img src="img/music/gara7.jpg" class="video music_content" id="V4">
    <img src="img/music/todalanoche.jpg" class="video music_content" id="V3">
    <img src="img/music/cometelospiego.jpg" class="video music_content" id="V2">
    <img src="img/music/balaclava.jpg" class="video music_content" id="V1">
    `;
  } else {
    document.getElementById("video_container").innerHTML =
      `
    <video src="img/narrative/tobeornottobe.mp4" type="video/mp4" class="video" id="V19" preload="auto" pause loop muted playsinline></video>
    <video src="img/narrative/einfall.mp4" type="video/mp4" class="video" id="V18" preload="auto" pause loop muted playsinline></video>
    <video src="img/narrative/confessioni.mp4" type="video/mp4" class="video" id="V17" preload="auto" pause loop muted playsinline></video>
    <video src="img/brand/francia.mp4" type="video/mp4" class="video adv_content" id="V16" preload="auto" pause loop muted playsinline></video>
    <video src="img/brand/mango_home.mp4" type="video/mp4" class="video adv_content" id="V15" preload="auto" pause loop muted playsinline></video>
    <video src="img/brand/puma.mp4" type="video/mp4" class="video adv_content" id="V14" preload="auto" pause loop muted playsinline></video>
    <video src="img/brand/mango_man.mp4" type="video/mp4" class="video adv_content" id="V13" preload="auto" pause loop muted playsinline></video>
    <video src="img/brand/timberland.mp4" type="video/mp4" class="video adv_content" id="V12" preload="auto" pause loop muted playsinline></video>
    <video src="img/brand/stoffa_lookbook.mp4" type="video/mp4" class="video adv_content" id="V11" preload="auto" pause loop muted playsinline></video>
    <video src="img/documentary/iononhopaura.mp4" type="video/mp4" class="video documentary_content" id="V10" preload="auto" pause loop muted playsinline></video>
    <video src="img/documentary/lafuria.mp4" type="video/mp4" class="video documentary_content" id="V9" preload="auto" pause loop muted playsinline></video>
    <video src="img/music/giornoenotte.mp4" type="video/mp4" class="video music_content" id="V8" preload="auto" pause loop muted playsinline></video>
    <video src="img/music/habitatcielo.mp4" type="video/mp4" class="video music_content" id="V7" preload="auto" pause loop muted playsinline></video>
    <video src="img/music/chilometri.mp4" type="video/mp4" class="video music_content" id="V6" preload="auto" pause loop muted playsinline></video>
    <video src="img/music/crescere.mp4" type="video/mp4" class="video music_content" id="V5" preload="auto" pause loop muted playsinline></video>
    <video src="img/music/gara7.mp4" type="video/mp4" class="video music_content" id="V4" preload="auto" pause loop muted playsinline></video>
    <video src="img/music/todalanoche.mp4" type="video/mp4" class="video music_content" id="V3" preload="auto" pause loop muted playsinline></video>
    <video src="img/music/cometelospiego.mp4" type="video/mp4" class="video music_content" id="V2" preload="auto" pause loop muted playsinline></video>
...
function select_section() {
  ...
  jQuery(document).ready(function() {
    function resizeForm() {
      ...
      if (width > 1200) {
        ...
        $(".narrative").on("mouseover", function() {
          $("body").css("cursor", "pointer");
  ...
  $(".music, .header_title").on("click", function() {
    ...
    if (document.getElementById("V1").tagName == "VIDEO") {
      ...
      document.getElementById("V18").pause();
      document.getElementById("V19").pause();
      ...
      document.getElementById("V18").currentTime = 0;
      document.getElementById("V19").currentTime = 0;
    } else {};
    ...
    document.getElementById("V18").style.opacity = "1";
    document.getElementById("V19").style.opacity = "1";
    document.getElementById("scrollify_section").innerHTML =
      ...
      <div class="section selected" data-section-name="section1">
  		...
  		<div class="section" data-section-name="section2">
  			<div class="credits_background"></div>
  			<div class="text">
  				<p class="title">Come te lo spiego</p>
  				<p class="subtitle">Gotti</p>
  				<p class="description">Music Video</p>
  				<p class="role">
  					regia @98matteodelia<br>
  					dop @jacopo_ambroggio<br>
  					1ac @zambo.mov<br>
  					dronista @teodibiase_photography<br>
  					color grading @mattia.saggiomo<br>
  					graphic design @omtode
  				</p>
  			</div>
  		</div>
  		<div class="section" data-section-name="section3">
  			<div class="credits_background"></div>
  			<div class="text">
  				<p class="title">Toda la noche</p>
  				<p class="subtitle">Lorenzza</p>
  				<p class="description">Music Video</p>
  				<p class="role">
  					regia @98matteodelia @davide_vicari<br>
  					dop @jacopo_ambroggio<br>
  					porto seguro fixer @esdrasagnes<br>
  					1ac @zambo.mov<br>
  					color grading @davide.pini.color<br>
  					graphic design @bianco.svg
  				</p>
  			</div>
  		</div>
  		...
  		<div class="section" data-section-name="section8">
  			<div class="credits_background"></div>
  			<div class="text">
            ...
            if (width < 1125) {
              ...
              $(".credits_line").css("width", "1.5dvh");
					...
					if (index === 1) {
						...
						player.loadVideo(1170111154).then(function(id) {
							// the video successfully loaded
						}).catch(function(error) {
							switch (error.name) {
								case 'TypeError':
            ...
            if (width < 1125) {
              ...
              $(".credits_line").css("width", "1.5dvh");
					...
					if (index === 2) {
						...
						player.loadVideo(1168451560).then(function(id) {
							// the video successfully loaded
						}).catch(function(error) {
							switch (error.name) {
								case 'TypeError':
            ...
            if (width < 1125) {
              ...
              $(".credits_line").css("width", "1.5dvh");
					...
					if (index === 4) {
						...
						player.loadVideo(1168449099).then(function(id) {
							// the video successfully loaded
						}).catch(function(error) {
							switch (error.name) {
								case 'TypeError':
    ...
    if (width > 1200) {
      ...
      $(".narrative p").css("border-top", "1px solid rgba(250,250,250,0)");
      $("#expand").css("display", "initial");
      $(".credits_line").css("width", "1.5dvh");
      $(".exit_credits").css("display", "none");
      $(".credits_background").css("display", "none");
  ...
  $(".narrative").on("click", function() {
      ...
      $.scrollify({
        ...
        before: function(index) {
          ...
          if (index === 1) {
            document.getElementById("current_page").innerHTML =
              "2";
            document.getElementById("V17").style.opacity = "0";
            document.getElementById("V18").style.opacity = "1";
            if (document.getElementById("V18").tagName == "VIDEO") {
              document.getElementById("V18").play();
            } else {};
          ...
          if (index === 2) {
            document.getElementById("current_page").innerHTML =
              "3";
            document.getElementById("V18").style.opacity = "0";
            if (document.getElementById("V19").tagName == "VIDEO") {
              document.getElementById("V19").play();
            } else {};
    ...
    if (width > 1200) {
      ...
      $(".documentary p").css("border-top", "1px solid rgba(250,250,250,0)");
      $(".adv p").css("border-top", "1px solid rgba(250,250,250,0)");
      $(".narrative p").css("border-top", "1px solid white");
      $("#expand").css("display", "initial");
      $(".credits_line").css("width", "1.5dvh");
      $(".exit_credits").css("display", "none");
      $(".credits_background").css("display", "none");
