...
function mobile_src() {
  ...
  if (width < 1200) {
    document.getElementById("video_container").innerHTML =
      `
    <img src="img/narrative/tobeornottobe.jpg" class="video" id="V17">
    <img src="img/narrative/einfall.jpg" class="video" id="V16">
    <img src="img/narrative/confessioni.jpg" class="video" id="V15">
    ...
    document.getElementById("video_container").innerHTML =
      `
    <video src="img/narrative/tobeornottobe.mp4" type="video/mp4" class="video" id="V17" preload="auto" pause loop muted playsinline></video>
		<video src="img/narrative/einfall.mp4" type="video/mp4" class="video" id="V16" preload="auto" pause loop muted playsinline></video>
		<video src="img/narrative/confessioni.mp4" type="video/mp4" class="video" id="V15" preload="auto" pause loop muted playsinline></video>
